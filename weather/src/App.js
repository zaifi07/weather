...
export default function App(){  
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://api.openweathermap.org/data/2.5/forecast?q=lahore&appid=57782102aaf0157a0365df843b0d203b&units=metric');
              ...
              <div className="right-card">
                <p>Weather Forcast</p>
                  <div className="temp">
                    ...
                    <h1>{day1_data?.[rightNow].weather[0].main??"Weather Discription"}</h1>
                  </div>
